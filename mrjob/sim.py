...
class SimMRJobRunner(MRJobRunner):
    ...
    * ``mapreduce.task.partition``
    ...
    def _setup_working_dir(self, working_dir):
        ...
        files = iteritems(self._working_dir_mgr.name_to_path('file'))
        ...
        archives = iteritems(self._working_dir_mgr.name_to_path('archive'))
    ...
    def _simulate_jobconf_for_step(
        ...
        version = self.get_hadoop_version()
        j = dict((translate_jobconf(k, version), v) for k, v in iteritems(j))
